...
***Note**: This is readme is stored in `docs/`as the generated readme will be created in the root directory when you run `wallamaker.sh` and deleted when running `cleanup.sh`.*
